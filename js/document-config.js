var documentConfig =
{
  ...
  shortName: "beheerportaal-test",
  pubDomain: "eu",
  specStatus: "wv",
  specType: "al",
  license: "cc-by",
  latestVersion: [
    "https://docs.geostandaarden.nl/eu/beheerportaal-test/"
  ],
  publishDate: "2023-11-29",
  publishVersion: "0.0.2",
  thisVersion: [
    "https://geonovum.github.io/eu-beheerportaal-test/"
  ],
  previousPublishDate: "2022-11-21",
  previousPublishVersion: "0.0.1",
  prevVersion: [
    "https://docs.geostandaarden.nl/eu/cv-al-beheerportaal-test-20221121/"
  ],
  previousMaturity: "cv",
  github: "https://github.com/geonovum/eu-beheerportaal-test/",
  issueBase: "https://github.com/geonovum/eu-beheerportaal-test/issues/",
  edDraftURI: "https://geonovum.github.io/eu-beheerportaal-test/",
  authors: [
    {
      name: "Michel Grothe",
      company: "Geonovum",
